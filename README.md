...
### 3. 获取/更新脚本
```bash
curl -Lo xray-REALITY+Web.sh https://github.com/twcoin/kirin10000-Xray-script/raw/main/Xray-REALITY+Web.sh
```

```bash
curl -Lo xray-TLS+Web-setup.sh https://github.com/twcoin/kirin10000-Xray-script/raw/main/Xray-TLS+Web-setup.sh
```
### 4. 执行脚本
```bash
